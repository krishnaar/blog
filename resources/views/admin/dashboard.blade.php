                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="{{ asset('assets/backend') }}/img/flags/US.png" </div> </td> <td>USA
                        </td>
                        <td class="text-right">
                          2.920
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="{{ asset('assets/backend') }}/img/flags/DE.png" </div> </td> <td>Germany
                        </td>
                        <td class="text-right">
                          1.300
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="{{ asset('assets/backend') }}/img/flags/AU.png" </div> </td> <td>Australia
                        </td>
                        <td class="text-right">
                          760
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="{{ asset('assets/backend') }}/img/flags/GB.png" </div> </td> <td>United Kingdom
                        </td>
                        <td class="text-right">
                          690
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="{{ asset('assets/backend') }}/img/flags/RO.png" </div> </td> <td>Romania
                        </td>
                        <td class="text-right">
                          600
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="{{ asset('assets/backend') }}/img/flags/BR.png" </div> </td> <td>Brasil
                        </td>
                        <td class="text-right">
                          550
                        </td>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card card-product">
          <div class="card-header card-header-image" data-header-animation="true">
            <a href="#pablo">
              <img class="img" src="{{ asset('assets/backend') }}/img/card-2.jpg">
            </a>
          </div>
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card card-product">
          <div class="card-header card-header-image" data-header-animation="true">
            <a href="#pablo">
              <img class="img" src="{{ asset('assets/backend') }}/img/card-3.jpg">
            </a>
          </div>
          <div class="card-body">
            <div class="card-actions text-center">
      ...
      <div class="col-md-4">
        <div class="card card-product">
          <div class="card-header card-header-image" data-header-animation="true">
            <a href="#pablo">
              <img class="img" src="{{ asset('assets/backend') }}/img/card-1.jpg">
            </a>
          </div>
          <div class="card-body">
            <div class="card-actions text-center">
