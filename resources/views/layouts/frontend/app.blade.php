...
<body class="blog-posts sidebar-collapse">
    ...
    <div class="page-header header-filter header-small" data-parallax="true"
        style="background-image: url('{{ asset('assets/frontend') }}/img/bg10.jpg');">
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-raised card-background"
                            style="background-image: url('{{ asset('assets/frontend') }}/img/examples/office2.jpg')">
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card card-raised card-background"
                            style="background-image: url('{{ asset('assets/frontend') }}/img/examples/blog8.jpg')">
                            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="card card-raised card-background"
                            style="background-image: url('{{ asset('assets/frontend') }}/img/examples/card-project6.jpg')">
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-plain card-blog">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img img-raised" src="{{ asset('assets/frontend') }}/img/bg5.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-plain card-blog">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img img-raised" src="{{ asset('assets/frontend') }}/img/examples/blog5.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-plain card-blog">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img img-raised" src="{{ asset('assets/frontend') }}/img/examples/blog6.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card card-profile card-plain">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="card-header card-header-image">
                                        <a href="#pablo">
                                            <img class="img" src="{{ asset('assets/frontend') }}/img/faces/card-profile4-square.jpg">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-7">
