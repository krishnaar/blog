...
<script src="{{ asset('assets/backend') }}/js/material-dashboard.min.js?v=2.1.0" type="text/javascript"></script>
...
<!-- Sharrre libray -->
<script src="{{ asset('assets/backend') }}/demo/jquery.sharrre.js"></script>
<script>
$(document).ready(function () {
...
<script>
$(document).ready(function () {
    // Javascript method's body can be found {{ asset('assets/backend') }}/js/demos.js
