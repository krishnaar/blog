                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  <div class="media">
                                    <div class="media-left">
                                      <a href="#">
                                        <img src="{{ Storage::disk('public')->url('profile/'.$comment->user->image) }}" class="media-object" width="64" height="64">
                                      </a>
                                    </div>
                                ...
                                <td>
                                  ...
                                  <form id="delete-from-{{ $comment->id }}" action="{{ route('author.comment.destroy', $comment->id) }}" method="post" style="display:none;">
                                    @csrf
                                    @method('DELETE')
                                  </form>
                                </td>
