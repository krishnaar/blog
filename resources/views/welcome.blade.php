...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{ asset('assets/frontend') }}/css/material-kit.min.css?v=2.1.1" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="{{ asset('assets/frontend') }}/demo/demo.css" rel="stylesheet" />
  <link href="{{ asset('assets/frontend') }}/demo/vertical-nav.css" rel="stylesheet" />
  <!-- Google Tag Manager -->
  <script>
    (function (w, d, s, l, i) {
      w[l] = w[l] || [];
...
<body class="index-page sidebar-collapse">
  ...
  <div class="page-header header-filter clear-filter" data-parallax="true"
    style="background-image: url('{{ asset('assets/frontend') }}/img/bg0.jpg');">
    <div class="container">
      <div class="row">
  ...
  <div class="main main-raised">
        ...
        <div id="checkRadios">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              ...
              <div class="form-check disabled">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="exampleRadio1" id="exampleRadios21" value="option2"
                ...
                <div class="col-lg-6 col-md-8 col-sm-3">
                  <div class="dropdown">
                    <button class="dropdown-toggle btn btn-primary btn-round btn-block" type="button"
                      id="multiDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Multilevel Dropdown
                    </button>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group label-floating">
                <label class="form-control-label bmd-label-floating" for="exampleInputTextarea"> You can write your text
                  here...</label>
    ...
    <div class="section section-navbars cd-section" id="navigation">
      ...
      <!--             navbar -->
      <div id="navbar">
        <div class="navigation-example" style="background-image: url('{{ asset('assets/frontend') }}/img//bg.jpg');">
                  ...
                  <li class="dropdown nav-item">
                    <a href="#pablo" class="profile-photo dropdown-toggle nav-link" data-toggle="dropdown">
                      <div class="profile-photo-small">
                        <img src="{{ asset('assets/frontend') }}/img/faces/avatar.jpg" alt="Circle Image" class="rounded-circle img-fluid">
                      </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                      <h6 class="dropdown-header">Dropdown header</h6>
                  ...
                  <div class="tab-content text-center">
                    <div class="tab-pane active" id="profile">
                      <p> I will be the leader of a company that ends up being worth billions of dollars, because I got
                        ...
                        think that&#x2019;s a responsibility that I have, to push possibilities, to show people, this is
                    ...
                    <div class="tab-pane" id="messages">
                      <p> I think that&#x2019;s a responsibility that I have, to push possibilities, to show people,
                        this is the level that things could be at. I will be the leader of a company that ends up being
                        worth billions of dollars, because I got the answers. I understand culture. I am the nucleus. I
                        think that&#x2019;s a responsibility that I have, to push possibilities, to show people, this is
                        the level that things could be at.</p>
                    </div>
                    <div class="tab-pane" id="settings">
                      <p>I think that&#x2019;s a responsibility that I have, to push possibilities, to show people, this
                        is the level that things could be at. So when you get something that has the name Kanye West on
                        it, it&#x2019;s supposed to be pushing the furthest possibilities. I will be the leader of a
                        company that ends up being worth billions of dollars, because I got the answers. I understand
                        culture. I am the nucleus.</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="section section-gray cd-section" id="footers">
      ...
      <div id="pre-footer-areas">
        ...
        <div class="subscribe-line subscribe-line-image" style="background-image: url('{{ asset('assets/frontend') }}/img/bg7.jpg');">
          <div class="container">
            <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="gallery-feed">
                      <img src="{{ asset('assets/frontend') }}/img/faces/card-profile6-square.jpg" class="img img-raised rounded" alt="">
                      <img src="{{ asset('assets/frontend') }}/img/faces/christian.jpg" class="img img-raised rounded" alt="">
                      <img src="{{ asset('assets/frontend') }}/img/faces/card-profile4-square.jpg" class="img img-raised rounded" alt="">
                      <img src="{{ asset('assets/frontend') }}/img/faces/card-profile1-square.jpg" class="img img-raised rounded" alt="">
                      <img src="{{ asset('assets/frontend') }}/img/faces/marc.jpg" class="img img-raised rounded" alt="">
                      <img src="{{ asset('assets/frontend') }}/img/faces/kendall.jpg" class="img img-raised rounded" alt="">
                      <img src="{{ asset('assets/frontend') }}/img/faces/card-profile5-square.jpg" class="img img-raised rounded" alt="">
                      <img src="{{ asset('assets/frontend') }}/img/faces/card-profile2-square.jpg" class="img img-raised rounded" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="content">
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <p>Probably the best UI Kit in the world! We know you&apos;ve been waiting for it, so don&apos;t be
                      shy!</p>
                  </div>
                  <div class="col-md-2">
                    <h5>About</h5>
      ...
      <div class="container tim-container">
        ...
        <div id="images">
          ...
          <div class="row">
            <div class="col-sm-2">
              <h4>Rounded Image</h4>
              <img src="{{ asset('assets/frontend') }}/img/faces/avatar.jpg" alt="Rounded Image" class="rounded img-fluid">
            </div>
            ...
            <div class="col-sm-2 ml-auto">
              ...
              <img src="{{ asset('assets/frontend') }}/img/faces/avatar.jpg" alt="Raised Image" class="img-raised rounded img-fluid">
            </div>
            <div class="col-sm-2 ml-auto">
              <h4>Circle Raised</h4>
              <img src="{{ asset('assets/frontend') }}/img/faces/avatar.jpg" alt="Thumbnail Image"
                  ...
                  <table class="table table-shopping">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="img-container">
                            <img src="{{ asset('assets/frontend') }}/img/product1.jpg" alt="...">
                          </div>
                        </td>
                        <td class="td-name">
                      ...
                      <tr>
                        <td>
                          <div class="img-container">
                            <img src="{{ asset('assets/frontend') }}/img/product2.jpg" alt="...">
                          </div>
                        </td>
                        <td class="td-name">
                      ...
                      <tr>
                        <td>
                          <div class="img-container">
                            <img src="{{ asset('assets/frontend') }}/img/product3.jpg" alt="...">
                          </div>
                        </td>
                        <td class="td-name">
            ...
            <div class="row">
              <div class="col-md-8 ml-auto mr-auto">
                <div class="media-area">
                  ...
                  <div class="media">
                    <a class="float-left" href="#pablo">
                      <div class="avatar">
                        <img class="media-object" src="{{ asset('assets/frontend') }}/img/faces/avatar.jpg" alt="...">
                      </div>
                    </a>
                    <div class="media-body">
                      ...
                      <p>Chance too good. God level bars. I&apos;m so proud of @LifeOfDesiigner #1 song in the country.
                        Panda! Don&apos;t be scared of the truth because we need to restart the human foundation in
                        truth I stand with the most humility. We are so blessed!</p>
                      <p>All praises and blessings to the families of people who never gave up on dreams. Don&apos;t
                        forget, You&apos;re Awesome!</p>
                      ...
                      <div class="media media-post">
                        <a class="author float-left" href="#pablo">
                          <div class="avatar">
                            <img class="media-object" alt="64x64" src="{{ asset('assets/frontend') }}/img/faces/kendall.jpg">
                          </div>
                        </a>
                        <div class="media-body">
                  ...
                  <div class="media">
                    <a class="float-left" href="#pablo">
                      <div class="avatar">
                        <img class="media-object" alt="Tim Picture" src="{{ asset('assets/frontend') }}/img/faces/marc.jpg">
                      </div>
                    </a>
                    <div class="media-body">
                      ...
                      <p>Hello guys, nice to have you on the platform! There will be a lot of great stuff coming soon.
                      ...
                      <div class="media">
                        <a class="float-left" href="#pablo">
                          <div class="avatar">
                            <img class="media-object" alt="64x64" src="{{ asset('assets/frontend') }}/img/faces/avatar.jpg">
                          </div>
                        </a>
                        <div class="media-body">
                          <h4 class="media-heading">Tina Andrew
                          ...
                          <p>Hello guys, nice to have you on the platform! There will be a lot of great stuff coming
                            soon. We will keep you posted for the latest news.</p>
                          <p> Don&apos;t forget, You&apos;re Awesome!</p>
                          <div class="media-footer">
                            <a href="#pablo" class="btn btn-primary btn-link float-right" rel="tooltip"
                              title="Reply to Comment">
                ...
                <div class="media media-post">
                  <a class="author float-left" href="#pablo">
                    <div class="avatar">
                      <img class="media-object" alt="64x64" src="{{ asset('assets/frontend') }}/img/placeholder.jpg">
                    </div>
                  </a>
                  <div class="media-body">
                    <form class="form">
      ...
      <div class="section-gray">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="card card-blog">
                  <div class="card-header card-header-image">
                    <a href="#pablo">
                      <img class="img" src="{{ asset('assets/frontend') }}/img/examples/card-blog1.jpg">
                ...
                <div class="card bg-info">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">
                      <a href="#pablo">&quot;You Don&apos;t Have to Sacrifice Joy to Build a Fabulous Business and
                        Life&quot;</a>
                    </h4>
                  </div>
                  <div class="card-footer">
                    <div class="author">
                      <a href="#pablo">
                        <img src="{{ asset('assets/frontend') }}/img/faces/avatar.jpg" alt="..." class="avatar img-raised">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="card">
                  ...
                  <div class="card-footer ">
                    <div class="author">
                      <a href="#pablo">
                        <img src="{{ asset('assets/frontend') }}/img/faces/christian.jpg" alt="..." class="avatar img-raised">
                        <span>Lord Alex</span>
                      </a>
                    </div>
                    <div class="stats ml-auto">
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-6">
                    <div class="card card-blog">
                      <div class="card-header card-header-image">
                        <a href="#pablo">
                          <img class="img" src="{{ asset('assets/frontend') }}/img/examples/blog8.jpg">
                        </a>
                      </div>
                      <div class="card-body ">
                        <h6 class="card-category text-danger">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card card-profile">
                  <div class="card-header card-header-image">
                    <a href="#pablo">
                      <img class="img" src="{{ asset('assets/frontend') }}/img/examples/card-profile4.jpg">
                      <div class="card-title">
                        Tania Andrew
                      </div>
                    </a>
              ...
              <div class="col-md-4">
                <div class="card card-profile">
                  <div class="card-header card-header-image">
                    <a href="#pablo">
                      <img class="img" src="{{ asset('assets/frontend') }}/img/examples/card-profile1.jpg">
                    </a>
                  </div>
                  <div class="card-body ">
              ...
              <div class="col-md-4">
                <div class="card card-profile">
                  <div class="card-avatar">
                    <a href="#pablo">
                      <img class="img" src="{{ asset('assets/frontend') }}/img/faces/marc.jpg">
                    </a>
                  </div>
                  <div class="card-body ">
                    <h6 class="card-category text-gray">CEO / Co-Founder</h6>
        ...
        <div class="cards">
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="card card-background" style="background-image: url('{{ asset('assets/frontend') }}/img/examples/office1.jpg')">
                  <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="card card-background" style="background-image: url('{{ asset('assets/frontend') }}/img/examples/card-blog3.jpg')">
                  <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card card-pricing card-background"
                  style="background-image: url('{{ asset('assets/frontend') }}/img/examples/card-blog3.jpg')">
                  <div class="card-body">
                ...
                <div class="rotating-card-container">
                  <div class="card card-rotate card-background">
                    <div class="front front-background"
                      style="background-image: url('{{ asset('assets/frontend') }}/img/examples/card-blog5.jpg');">
                      <div class="card-body">
                    ...
                    <div class="back back-background"
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-description">As an Admin, you have shortcuts to edit, view or delete the posts.
                        </p>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="rotating-card-container manual-flip">
                  <div class="card card-rotate">
                    <div class="front front-background"
                      style="background-image: url('{{ asset('assets/frontend') }}/img/examples/card-blog6.jpg');">
                      <div class="card-body">
                        <h6 class="card-category">Full Background Card</h6>
                        <a href="#pablo">
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="title">
                ...
                <h4>Material Kit PRO is coming with the famous colored shadows. That means each image from the cards is
                  getting an unique color shadow. You don&apos;t have to do anything to activate them, just enjoy the
                  new look of your website.</h4>
                <br>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="card card-blog">
                <div class="card-header card-header-image">
                  <a href="#pablo">
                    <img src="{{ asset('assets/frontend') }}/img/examples/color1.jpg" alt="">
                  </a>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card card-blog">
                <div class="card-header card-header-image">
                  <a href="#pablo">
                    <img src="{{ asset('assets/frontend') }}/img/examples/color2.jpg" alt="">
                  </a>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card card-blog">
                <div class="card-header card-header-image">
                  <a href="#pablo">
                    <img src="{{ asset('assets/frontend') }}/img/examples/color3.jpg" alt="">
                  </a>
                </div>
                <div class="card-body ">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="card card-blog card-plain">
                  <div class="card-header card-header-image">
                    <a href="#pablo">
                      <img src="{{ asset('assets/frontend') }}/img/examples/blog5.jpg" alt="">
                      <div class="card-title">
                        This Summer Will be Awesome
                      </div>
                    </a>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="card card-blog card-plain">
                  <div class="card-header card-header-image">
                    <a href="#pablo">
                      <img class="img" src="{{ asset('assets/frontend') }}/img/examples/blog1.jpg">
                    </a>
                  </div>
                  <div class="card-body ">
                    <h6 class="card-category text-success">Legal</h6>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-6">
                    <div class="card card-blog card-plain">
                      <div class="card-header card-header-image">
                        <a href="#pablo">
                          <img class="img" src="{{ asset('assets/frontend') }}/img/examples/blog6.jpg">
                        </a>
                      </div>
                      <div class="card-body ">
                        <h6 class="card-category text-danger">
            ...
            <div class="col-md-5 col-sm-8">
              ...
              <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                <div class="fileinput-new thumbnail img-raised">
                  <img src="{{ asset('assets/frontend') }}/img/image_placeholder.jpg" alt="...">
                </div>
            ...
            <div class="col-md-3 col-sm-4">
              ...
              <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                <div class="fileinput-new thumbnail img-circle img-raised">
                  <img src="{{ asset('assets/frontend') }}/img/placeholder.jpg" alt="...">
                </div>
              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="{{ asset('assets/frontend') }}/img/bg2.jpg" alt="First slide">
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('assets/frontend') }}/img/bg3.jpg" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h4>
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('assets/frontend') }}/img/bg.jpg" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h4>
                        <i class="material-icons">location_on</i> Yellowstone National Park, United States
                      </h4>
        ...
        <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-8">
                ...
                <p>The first step is to create an account at
                  <a href="http://www.creative-tim.com/">Creative Tim</a>. You can choose a social network or go for the
                  classic version, whatever works best for you.</p>
              </div>
              <div class="col-md-4">
                <div class="picture">
                  <img src="{{ asset('assets/frontend') }}/img/dg1.jpg" alt="Thumbnail Image" class="rounded img-fluid">
                </div>
              </div>
            </div>
          </div>
          <div class="instruction">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="picture">
                  <img src="{{ asset('assets/frontend') }}/img/dg2.jpg" alt="Thumbnail Image" class="rounded img-fluid">
                </div>
              </div>
            </div>
          </div>
